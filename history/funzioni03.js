...
//   // Estrai tutte le flag
    // const flags = dati.atleta.map(a => a.flag);
//
//   // Usa un Set per ottenere i valori unici
//   const flagUniche = new Set(flags);
//   
//   console.log("479 " + flagUniche.size); // Output: 7

//const flags = atlete.map(a => a.flag);
//const uniqueFlags = [...new Set(flags)];
//console.log("Flag uniche:", uniqueFlags);
//console.log("Totale flag diverse:", uniqueFlags.length);
...
////             MAIN
//// --------------------------------
//TitleBar("22-07-2025","2025 Fencing World Championships","xxx") 
//
