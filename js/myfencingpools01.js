...
// Bottone
  ...
  const icon1 = document.createElement("i");
        icon1.classList.add("fa-solid", "fa-list"); // icona lista
...
//// Bottone
//  const tdRight = createEl("td", { colspan: 10 });
//        tdRight.style.border    = "none";
//        tdRight.style.textAlign = "right";
...
//        icon2.classList.add("fa-solid", "fa-list"); // icona lista
...
// Bottone
   ...
   const img2 = document.createElement("img");
         img2.src = "images/referee02white.png"; // percorso immagine
         img2.alt = "Referees";                  // testo alternativo
         img2.width = 24;                        // dimensioni (o via CSS)
         img2.height = 24;
